...
def pilih_login():
    ...
    os.system('clear')
    print logo1
    print"\033[0;97m___SELECT____"
    print"\033[1;90m[1]\x1b[1;93mBANGLADESH"
    time.sleep(0.05)
    print"\033[1;94m[2]\x1b[1;96mPakistan"
    time.sleep(0.05)
    print '\033[1;94m[3]\x1b[1;95mINDIA'
    time.sleep(0.05)
    print"\033[1;90m[4]\x1b[1;92mSomi brand YouTube Channel"
    time.sleep(0.05)
